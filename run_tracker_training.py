...
def train():
    ...
    # run trainer
    step_list, Loss_list = trainer(hp, run, design, final_score_sz, batched_data, image, templates_z, scores, loss, train_step, distance_to_gt,  z_crops, x_crops, siamNet, summary)
    ...
    fig.savefig('Learning plot.png', dpi=100)
